...
- [x] T2.1 (S2.1) İşletme ve mal sahibi tanımlama — 2026-09-18, backend (business_owners, admin/businesses API, 751 satır entegrasyon testi) + frontend (/yonetim liste + "İşletme aç", /yonetim/isletmeler/yeni, /yonetim/isletmeler/:id: ad/sahip düzeltme, sahip atama, onaylı pasifleştirme/yeniden aktifleştirme), 252 birim testi, 6 yeni E2E (tests/e2e/admin-businesses.spec.ts) + platform-login.spec.ts'in ana ekran doğrulaması güncellendi; 45/45 E2E (chromium) yeşil, webkit bu ortamda eksik sistem bağımlılığından koşulamadı
