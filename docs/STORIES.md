...
- [ ] Aynı sürümü açmış iki kullanıcı kaydederse ilk geçerli işlem tamamlanır, diğeri “Bu kayıt değişmiş. Güncel halini açıp tekrar kontrol et.” mesajını alır. İkinci işlem ilkinin bilgisini sessizce ezmez; kullanıcının düzeltme taslağı karşılaştırma için korunur.
