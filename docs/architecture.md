...
- Admin module (src/server/usecases/admin-businesses, admin-vehicles; planned users/audit) — businesses, owners, vehicles (create/edit/deactivate implemented), vehicle password reset per role (implemented T2.3), team accounts, support; full audit
