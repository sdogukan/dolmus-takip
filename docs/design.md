...
| 8 | Ekip — işletme/araç bulma (implemented: 'Plaka veya işletme ara' + 'Durum' filter mirrored in the URL; empty query lists businesses, a query lists vehicle cards with 'Destek ekranını aç' / 'Araç bilgisi'; '+ İşletme aç' and 'İşlem geçmişi' links) | /yonetim |
