...
_One row per architecture flow (7 flows ↔ rows 1–7); row 8 covers driver management (S2.4), whose flow card is an open question in this draft. Currently 6 E2E spec files exist (vehicle-login, platform-login, admin-businesses, admin-vehicles, login-accessibility, drivers)._
