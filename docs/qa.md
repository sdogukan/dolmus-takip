...
- Page: Şoför günlük kayıt (save, planned M3) / Sahip çalışma kaydı (planned) — draft + request_id persistence (use-stored-draft, client-state)
