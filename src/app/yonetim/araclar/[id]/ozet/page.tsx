...
/**
 * /yonetim/araclar/[id]/ozet — destek alanında araç özeti (sahip özetinin ekip modu). `../destek/page.tsx`
...
export const metadata: Metadata = {
  title: "Özet — Dolmuş Takip",
};

export default async function VehicleSupportSummaryPage({
  params,
}: {
  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-[35rem] flex-col gap-6 px-4 py-6">
      ...
      <OwnerSummary key={vehicleId} targetVehicleId={vehicleId} />
    </main>
  );
}
