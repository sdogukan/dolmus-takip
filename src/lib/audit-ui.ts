...
const ACTION_LABELS: Record<string, string> = {
  ...
  "business.deactivate": "İşletme pasifleştirildi",
  "business.reactivate": "İşletme yeniden aktifleştirildi",
  "vehicle.create": "Araç oluşturuldu",
  "vehicle.update": "Araç bilgisi değişti",
  "vehicle.deactivate": "Araç pasifleştirildi",
  "vehicle.reactivate": "Araç yeniden aktifleştirildi",
