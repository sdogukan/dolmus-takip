...
export const WORK_ENTRY_MESSAGES = {
  ...
  savedWho: (name: string, plate: string): string => `${name} · ${plate}`,
  savedWhen: (date: string, range: string): string => `${date} · ${range}`,
  nextDaySuffix: "(ertesi gün)",
  resultHint: "Mal sahibi parayı aldığında burada görebileceksin.",
  refresh: "Yenile",
  loginLink: "Yeniden giriş yap",
  savedRemainder: "Teslim edilecek tutar",
  savedOwnerRemainder: "Giderlerden sonra kalan",
  // Sonucu belirsiz gönderim: alanlar kilitli; aynı istek yeniden kontrol edilir.
  checking: COMMON_SCREEN_MESSAGES.checkingResultAfterDisconnect,
  checkingButton: "Kontrol ediliyor…",
  checkNow: "Sonucu şimdi kontrol et",
  checkHint: "Bağlantı gelince kendiliğinden tekrar kontrol edilir. Aynı kayıt yalnız bir kez oluşur.",
  stillOffline: "Bağlantı yok. Sonuç bağlantı gelince kontrol edilecek.",
  ...
  // T3.6 — kayıt detayı ve düzenleme.
  openEntry: "Kaydı aç",
  detailTitle: "Kayıt detayı",
  currentValuesTitle: "Güncel kayıt",
  versionLabel: (version: number): string => `Sürüm ${version}`,
  kindLabel: "Kayıt türü",
  kindOwner: "Mal sahibi çalıştı",
  kindDriver: "Şoför çalıştı",
  detailPerson: "Çalışan",
  detailDate: "Çalışılan gün",
  detailTime: "Saat",
  detailDuration: "Süre",
  detailGross: "Hasılat",
  detailFuel: "Mazot",
  detailOther: "Diğer masraf",
  detailShare: "Şoför payı",
  detailRemainder: "Teslim edilecek tutar",
  detailOwnerRemainder: "Giderlerden sonra kalan",
  statusConfirmed: "Onaylandı",
  editTitle: "Kaydı düzenle",
  editSubmit: "Değişiklikleri kaydet",
  editSubmitRetry: "Değişikliği tekrar dene",
  updated: "Değişiklikler kaydedildi",
  editUnknownResult:
    "Değişikliğin gönderilip gönderilmediği bilinmiyor. Alanlar kilitlendi; tekrar dene, aynı değişiklik yalnız bir kez uygulanır.",
  personInactiveSuffix: (name: string): string => `${name} (pasif)`,
  driverEditWindow:
    "Şoför olarak yalnız bugünün henüz doğrulanmamış kaydını düzenleyebilirsin.",
  useCurrent: "Güncel değerleri yükle",
  keepMine: "Benim değerlerimle devam et",
  yourDraftTitle: "Senin değişikliklerin",
  refreshing: "Güncel kayıt okunuyor…",
  refreshFailed: "Güncel kayıt okunamadı. Tekrar dene.",
  discardDraft: "Taslağı sil",
  confirmedDraftKept: "Kaydedilmemiş değişikliklerin bu cihazda saklı.",
  backToOwner: "← Özet",
  ...
  // Kayıt geçmişi (salt okunur).
  historyLink: "Geçmişi gör",
  historyTitle: "Kayıt geçmişi",
  historyBack: "← Kayıt detayı",
  historyListTitle: "Değişiklikler",
  historyCreated: "Kayıt oluşturuldu",
  historyUpdated: "Kayıt düzenlendi",
  historyConfirmation: "Teslim doğrulandı",
  historyReceived: (amount: string): string => `Alınan tutar: ${amount}`,
  historyCurrent: "Güncel",
  historyChange: (label: string, before: string, after: string): string => `${label}: ${before} → ${after}`,
  historyOnBehalfOfOwner: (name: string): string => `Sahip adına ${name}`,
  historyOnBehalfOfDriver: (name: string): string => `Şoför adına ${name}`,
  historyFieldLabels: {
    person: "Çalışan",
    workDate: "Çalışılan gün",
    startsAt: "Başlangıç",
    endsAt: "Bitiş",
    grossCents: "Hasılat",
    fuelCents: "Mazot",
    otherExpenseCents: "Diğer masraf",
    otherExpenseNote: "Masraf açıklaması",
    shareCents: "Şoför payı",
    remainderCents: "Teslim edilecek tutar",
    receivedCents: "Alınan tutar",
  },
} as const;
